...
public class TimeRangeScanReverse {
    ...
    public static void testTallTableDesign() throws IOException {
        ...
        Scan s = new Scan();
        s.setTimeRange (1464018596031L, 1464018630537L);
    ...
    public static void testTimeSeriesTableDesign() throws IOException {
        ...
        Scan s = new Scan(Bytes.toBytes("C_1464022420_0000"),Bytes.toBytes("F_1464022510_FFFF"));
        ResultScanner scanner = table.getScanner(s);
        for (Result rr = scanner.next(); rr != null; rr = scanner.next()) {
        	counter++;
